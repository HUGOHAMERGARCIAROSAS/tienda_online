!(function () {
    ...
    var p = {
            ...
            renameFile: null,
            forceFallback: !1,
            dictDefaultMessage: "Suelta los archivos aquí",
            dictFallbackMessage:
                "Este navegador no soporta arrastrar y soltar.",
            dictFallbackText:
                "Por favor, utiliza el formulario a continuación.",
            dictFileTooBig:
                "File is too big ({{filesize}}MiB). Max filesize: {{maxFilesize}}MiB.",
            dictInvalidFileType: "No se puede subir archivos de este tipo.",
            dictResponseError: "Server responded with {{statusCode}} code.",
            dictCancelUpload: "Cancelar subida",
            dictUploadCanceled: "Upload canceled.",
            dictCancelUploadConfirmation:
                "¿Desea cancelar esta subida?",
                    ...
                    },
                    {
                        ...
                        value: function (e) {
                            ...
                            for (
                                /[^A-Za-z0-9\+\/\=]/g.exec(e) &&
                                    console.warn(
                                        "There were invalid base64 characters in the input text.\nValid base64 characters are A-Z, a-z, 0-9, '+', 'https://demo.topylo.com/',and '='\nExpect errors in decoding."
                                    ),
