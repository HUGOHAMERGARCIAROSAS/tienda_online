<template id="favorites-sidebar-template">
        ...
        <div class="tabs">
            <li role="tab">
                <a class="smooth02" data-pktabname="el-favorites" data-pktabgroup="el-products-inner"
                    data-pktype="sidebar" href="#" title="Favorites">
                    Favoritos
                </a>
            </li>
        </div>
        <div class="tabsContent">
            <div class="tab-pane" data-pktabcontent="el-favorites" data-pktabgroup="el-products-inner"
                role="tabpanel">
