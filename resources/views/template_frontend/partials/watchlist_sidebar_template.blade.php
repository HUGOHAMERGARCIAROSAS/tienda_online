<template id="watchlist-sidebar-template">
        ...
        <div class="tabs">
            <li role="tab">
                <a class="smooth02" data-pktabname="el-watchlist" data-pktabgroup="el-products-inner"
                    data-pktype="sidebar" href="#" title="watchlist">
                    Lista de deseos
                </a>
            </li>
        </div>
        <div class="tabsContent">
            <div class="tab-pane" data-pktabcontent="el-watchlist" data-pktabgroup="el-products-inner"
                role="tabpanel">
